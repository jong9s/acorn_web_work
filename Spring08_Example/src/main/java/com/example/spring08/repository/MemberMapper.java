...
// 해당 bean 을 Service 혹은 Dao 에 주입을 받아서 사용할 수 있다.
...
public interface MemberMapper {
	...
	public int delete(int num); // delete 된 rowCount 가 리턴된다.
	...
	""")
	@SelectKey(statement = "SELECT member_seq.NEXTVAL FROM DUAL", keyProperty = "num", resultType = int.class, before = true)
