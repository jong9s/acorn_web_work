 ...
 *   
 *   - SecurityFilter 에 whiteList 에 "/update/" 를 추가해야 동작한다
 *   - /upload/xxx.png , /upload/xxx.jpg 형식의 요청을 이 서블릿에서 처리합니다.
 *   - img 요소에 특정 이미지를 보여주려면 <img src = "컨텍스트경로/upload/저장된 파일명"> 형식으로 코딩하면 됩니다.
 */
