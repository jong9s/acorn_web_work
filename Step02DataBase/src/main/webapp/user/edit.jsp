...
<body>
	...
	<script>
		...
		// input 요소중에 name 속성의 값이 profileImage 인 요소를 선택해서 이벤트 리스너 함수 등록ㅁ
		document.querySelector("input[name=profileImage]").addEventListener("change", (e)=>{
			...
			reader.onload = () => {
				...
				const img = `<img src="\${reader.result}" style="width:100px; height:100px; border-radius:50%">`;
				// img 마크업 형식의 문자열을 실제로 HTML 로 해석이 되게끔 a 요소 안에 넣기
